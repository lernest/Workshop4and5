  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.state.feedItem, this.state.index, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.state.feedItem, this.state.index, 4, callbackFunction);
      }
    }
  }
    ...
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br />
          <a href="#" onClick={(e) => this.handleLikeClick(e)}>{likeButtonText}</a> · <a href="#">Reply</a> · <span className="glyphicon glyphicon-thumbs-up"></span> {this.state.likeCounter.length} · {unixTimeToString(this.props.postDate)}
        </div>
      </div>
    )
  }
